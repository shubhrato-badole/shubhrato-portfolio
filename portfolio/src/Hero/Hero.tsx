  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="text-center z-10 px-6 max-w-4xl pt-16">
        ...
        <h1
          className="font-['Syne'] font-bold leading-none mb-5"
        ...
        <div
          className="font-['Syne'] font-bold mb-8 min-h-8 text-slate-300 tracking-wide"
          style={{ fontSize: "clamp(1.2rem, 5vw, 1.8rem)" }}
        >
          {text}
          <span
            className="inline-block w-[2px] ml-1 bg-violet-400"
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
        <span className="font-mono text-[10px] text-slate-700 tracking-[0.2em]">
          SCROLL
        </span>
