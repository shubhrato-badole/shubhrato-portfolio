          ...
          {status === 'sent' ? (
            ...
            >
              ...
              <button
                ...
                className="font-mono text-xs text-white bg-purple-600 border border-purple-600 rounded-full px-4 py-2 hover:bg-primary/20 transition-colors duration-200"
              >
                Send another →
              </button>
            </motion.div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              {(['name', 'email', 'message'] as const).map((f, i) => (
                <div key={f}>
